...
int main()
{
	...
	while (true)
	{
		...
		vector<Vec2f> lines; lines.reserve(1000);
		HoughLines(cannyImage, lines, 1, CV_PI / 180, 100);       // Hough transformation formula to draw lines on the images
